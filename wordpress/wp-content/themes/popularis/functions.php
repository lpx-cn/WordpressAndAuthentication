 ...
 */
define('POPULARIS_VERSION', '1.0.1');
    ...
    function popularis_setup() {
        ...
        add_theme_support('recommend-plugins', array(
            ...
            'elementor' => array(
                ...
                /* translators: %s plugin name string */
                'description' => sprintf(esc_attr__('To enable shop features, please install and activate the %s plugin.', 'popularis'), '<strong>Elementor</strong>'),
            ),
        ));
    }
...
function popularis_theme_stylesheets() {
    ...
    if (class_exists('WooCommerce')) {
        wp_enqueue_style('popularis-woocommerce', get_template_directory_uri() . '/assets/css/woocommerce.css', array(), POPULARIS_VERSION);
    }
}
