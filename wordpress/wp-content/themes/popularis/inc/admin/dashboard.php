    ...
    if (!get_user_meta($user_id, esc_html($theme_data->get('TextDomain')) . '_notice_ignore')) {
        ...
        <div class="updated notice notice-success notice-alt is-dismissible">
            <p>
                ...
                <?php if (is_plugin_active('themes4wp-demo-import/themes4wp-demo-import.php')) { ?>
                ...
                <?php } else { ?>
                    <a href="<?php echo esc_url('http://demo.themes4wp.com/documentation/one-click-demo-import-popularis/') ?>" class="button" target="_blank" style="text-decoration: none;">
                        <?php esc_html_e('Details', 'popularis'); ?>
                    </a>
                <?php } ?>
            </p>
        </div>
...
function popularis_render_recommend_plugins($recommend_plugins = array()) {
    foreach ($recommend_plugins as $plugin_slug => $plugin_info) {
        ...
        if (!is_plugin_active($active_file_name)) {
            $button_txt = __('Install Now', 'popularis');
            if (!$status) {
                ...
                $button_txt = __('Activate', 'popularis');
            }
...
function popularis_recommended_import_construct() {
    ...
    if (is_plugin_active('themes4wp-demo-import/themes4wp-demo-import.php')) {
        ?>
        <a href="?page=pt-one-click-demo-import" class="nav-tab<?php echo $tab == 'import_data' ? ' nav-tab-active' : null; ?>"><?php esc_html_e('One Click Demo Import', 'popularis') ?></a>
    <?php } else { ?>
                ...
                <div class="theme_info_column clearfix">
                    <div class="theme_info_left">
                        ...
                        <div class="theme_link">
                            ...
                            <p>
                                <a href="<?php echo esc_url('http://demo.themes4wp.com/documentation/popularis/'); ?>" target="_blank" class="button button-secondary">
                                    <?php
                                    /* translators: %s theme name */
                        ...
                        <div class="theme_link">
                            ...
                            <p>
                                <a href="<?php echo esc_url('https://themes4wp.com/contact/'); ?>" target="_blank" class="button button-secondary"><?php esc_html_e('Contact us', 'popularis'); ?></a>
                            </p>
                        </div>
                    </div>
        ...
        <?php if ($tab == 'import_data') { ?>
            <div class="import-data-tab info-tab-content">
                <?php if (is_plugin_active('themes4wp-demo-import/themes4wp-demo-import.php')) { ?>
                    ...
                    /* translators: %1$s documentation string with link */
                    printf(__('You can import the demo content with just one click. For step-by-step video tutorial, see %1$s', 'popularis'), '<a class="documentation" href="' . esc_url('http://demo.themes4wp.com/documentation/popularis/one-click-demo-import/') . '" target="_blank">' . esc_html__('documentation', 'popularis') . '</a>');
                }
                ?>
            </div>
        <?php } ?>
