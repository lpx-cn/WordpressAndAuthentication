...
if (!function_exists('popularis_generate_construct_footer')) :
    ...
    function popularis_generate_construct_footer() {
        ...
        <div class="footer-credits-text text-center">
            ...
            <span class="sep"> | </span>
            <?php
            /* translators: %1$s: Populars theme name with themes4wp.com URL */
            printf(esc_html__('Theme: %1$s', 'popularis'), '<a href="' . esc_url('https://themes4wp.com/theme/popularis/') . '">Popularis</a>');
            ?>
        </div> 
        <?php
    }
